...
public class NonTerminalZipHB extends SymbolZipHB implements NonTerminalZip<NonTerminalZipHB, TerminalZipHB> {
	...
	@Override
	public void addToCriticalChildren(SymbolZip<NonTerminalZipHB, TerminalZipHB> symb) {
		this.criticalChildren.add((SymbolZipHB) symb);
	}

	@Override
	public ArrayList<SymbolZipHB> getRule() {
		return this.rule;
	}

	@Override
	public void setRule(ArrayList<? extends SymbolZip<NonTerminalZipHB, TerminalZipHB>> r) {
